...
if __name__ == '__main__':
    pred_file = os.path.join(os.getcwd(), '../checkpoint2_submissions/averaged_predictions.csv')

    dates = ['2020-05-10', '2020-05-11']
    score = 0
    for date in dates:
        score += score_all_predictions(pred_file, date, '2020-05-10', key='deaths')[0]
